...
public class GameManager : MonoBehaviour
{
    ...
    // Hàm này được gọi khi nhấn nút "Select stage" (Scene 1)
    ...
    public void OnSelectStage(string stageName)
    {
        selectedStageName = stageName;
        Debug.Log($"Đã chọn stage: {selectedStageName}");
    }

    //This fuction is called when pressing "start game" button
